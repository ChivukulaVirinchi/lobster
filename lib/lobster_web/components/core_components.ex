defmodule LobsterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LobsterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LobsterWeb.Gettext, "errors", msg, opts)
    end
  end
